...
class GenerateQuizInputStep(Step):
  ...
  def execute(self, input: dict, context: dict):
    ...
    system_prompt = (
      ...
      "- question: a quiz question in Portuguese, written in a fun and curious tone, like you're talking to a friend. (Max 96 chars)\n"
      ...
      "- The quiz must be surprising, interesting or amusing — avoid overly technical or obvious questions\n"
      "- The question should be written in a curious and informal tone, using expressions like 'Você sabia que...', 'Incrivelmente...', 'Pouca gente conhece...'\n"
